 ...
 if(!isset($_SESSION['admin']))
 {
  ...
  if(isset($_POST["Submit"])){
    ...
    // move_uploaded_file($Docum_tmp,"images/".$Docum);
        ...
        $insertAss = "INSERT INTO assignments_record(module_code,title,description,document_name,Document_version,date,file)
        VALUES('".$MoCode."','".$Title."','".$Description."','".$Document_name."','".$Document_version."','".$Date."','".$File."')";
      ...
      <div class="form-grids row widget-shadow" data-example-id="basic-forms">
       ...
       <fieldset>
          ...
          <span class="FieldInfo">Document Name:</span><br><input type="text" name="Document_name" value=""><br>
		   <span class="FieldInfo">Document Name:</span><br><input type="int" name="Document_version" value=""><br>
